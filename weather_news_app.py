...
# Header
st.markdown('<div class="header-title"> Weather & News Search</div>', unsafe_allow_html=True)
...
if st.button("🔍 Get Weather & News", type="primary", use_container_width=True):
            ...
            if weather_response.status_code == 200:
                ...
                if news_response.status_code == 200:
                    ...
                    if articles:
                        ...
                        st.warning(" No news articles found for this region")
    ...
    # Show placeholder
    st.markdown('<div class="weather-card">', unsafe_allow_html=True)
    st.markdown("** Enter a location above to get weather and news!**")
